...
# Load dataset
df = pd.read_csv('/workspaces/smart_kitchen/smart_kitchen_assistant/backend/data/Food_Recipe.csv')
...
def find_recipes(user_ingredients):
    ...
    for index, row in df.iterrows():
        ...
        # Sort the matching recipes and return the top 5 based on some measure (e.g., the length of common ingredients)
